...
#ifndef TOPICNET_UDATA_LUA_UDATA_H
#define TOPICNET_UDATA_LUA_UDATA_H 1
...
namespace udata {
	...
	typename Udata<T>::TID * Udata<T> :: udata_push(lua_State *L, T *obj) {
		if(obj) {
			...
			luaL_getmetatable(L, TOPICNET_UDATA_LIB_META);
...
#endif	// TOPICNET_UDATA_LUA_UDATA_H
