...
---------------------colors----------------------
local edgecolor = {58/255, 108/255, 115/255}
local red = {247/255, 59/255, 81/255}
local pink = {221/255, 93/255, 101/255}
local green = {104/255, 197/255, 38/255}
local yellow = {251/255, 252/255, 29/255}
local blue = {98/255, 202/255, 215/255}
local highcol = {}
highcol[1] = {96/255, 176/255, 71/255}
highcol[2] = {255/255, 151/255, 32/255}
...
function drawPlane()
    ...
    for p=0, tpd:planeCount()-1 do
	   ...
	   else  gl.Color(0.1, 0.1, 0.1, 0.8) end
	   gl.LineWidth(0.5)
